...
// candidate counts by stage. These all take an already-open admin
// transaction (e.g. from `withAdmin`), unlike `getJobBySlug` above which
// opens its own candidate-context transaction.
